...
const JoinForm = () => {
  ...
  const clueText = isRegister ? 'Already Have An Account ?' : "Don't have an account?";
  ...
  return (
    ...
    <h1 className="text-dark text-3xl font-bold text-center mb-4">{currentStatue}</h1>
    ...
    <div className="text-center mt-6">
      <button className="btn bg-dark text-pampas "
        type="sutmit"
        onClick={handleSubmit}>{currentStatue}</button>
